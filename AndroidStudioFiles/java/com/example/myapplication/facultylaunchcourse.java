...
public class facultylaunchcourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facultylaunchcourse);
    ...
    {
        Intent intent1=new Intent(this,faclaunchcoursepagetwo.class);
