...
public class managestudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddroom=findViewById(R.id.addstdbtn);
    ...
    private void fetchUserOrders() {
        String url = "http://10.0.2.2/pavaniapp/admanstd.php"; // Replace with your PHP script's URL
                    ...
                    if (jsonResponse.getBoolean("status")) {
                        ...
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                View detailView = getLayoutInflater().inflate(R.layout.std_manage_block, null);
                                ...
                                updateButton.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent=new Intent(managestudents.this,updatestudent.class);
                                ...
                                paswrdchabtn.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent=new Intent(managestudents.this,changepassword.class);
                                        intent.putExtra("id",stdid);
                                        startActivity(intent);
                                    }
                                });
    ...
    private void deactivateroom(String room) {
        ...
        String updateUrl = "http://10.0.2.2/pavaniapp/admanstddea.php"; // Replace with your PHP script's update URL
