...
public class faclaunchcoursepagetwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faclaunchcoursepagetwo);
                        ...
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getApplicationContext(),
                                        R.array.fac_launch_array, android.R.layout.simple_spinner_item);
    ...
    private void updateData(String studentid, String selectedStatus, String clubidid) {
        String updateUrl = "http://10.0.2.2/pavaniapp/faclaunchcourseupdate.php";
